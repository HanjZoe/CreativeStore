            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('color.show', $color)}}">Цвет</a></li>
            ...
            <div class="row">
                <form action="{{route('color.update',$color)}}" method="post">
                    ...
                    <div class="form-group">
                        <input name="title" type="text" class="form-control" placeholder="Наименование" value="{{$color->title}}">
                        @error('title')
